...
export function formatDateRange(date: Date, view: "day" | "week" | "month") {
  const formatShort = new Intl.DateTimeFormat("en-GB", {
    day: "2-digit",
    month: "short",
    year: "numeric",
    timeZone: "UTC",
  ...
  if (view === "week") {
    ...
    return `${formatShort.format(start)} - ${formatShort.format(end)}`;
  }
